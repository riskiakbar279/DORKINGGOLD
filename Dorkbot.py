...
if __name__ == "__main__":
   print (R+"code  by : riskiakbar279 | Team : ITES")
 	print (W+43*"-")

	inurl = raw_input(B+"[?]"+G+" Inurl/urm    "+W+": ")
	site  = raw_input(B+"[?]"+G+" Website    "+W+": ")
	maxc  = raw_input(B+"[?]"+G+" paragraf "+W+": ")
